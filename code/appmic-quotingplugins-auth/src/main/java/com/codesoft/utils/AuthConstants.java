...
public class AuthConstants {
  ...
  public static final String MS_AUTH_SERVICE = "MS_AUTH_SERVICE";
  ...
  public static final String PORT_API_EMPLOYEE_USER_SERVICE = "http://127.0.0.1:8082/api/employees/user/loginByUsernameAndPassword";

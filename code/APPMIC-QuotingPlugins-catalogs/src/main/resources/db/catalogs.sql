...
-- Comments
COMMENT ON TABLE unit_of_measurement IS 'Tabla para almacenar las unidades de medida utilizadas en el sistema.';
COMMENT ON COLUMN unit_of_measurement.name IS 'Nombre de la unidad de medida.';
COMMENT ON COLUMN unit_of_measurement.description IS 'Descripción detallada de la unidad de medida.';
-- Insert
...
-- Comments
COMMENT ON TABLE catalog_item IS 'Tabla para almacenar datos globales como: tipos de documento, tipos de identificación utilizadas en el sistema.';
COMMENT ON COLUMN catalog_item.category IS 'Nombre del tipo de categoría.';
COMMENT ON COLUMN catalog_item.code IS 'Abreviatura del documento';
COMMENT ON COLUMN catalog_item.description IS 'Descripción del documento';
-- Insert
...
-- Comments
COMMENT ON TABLE adjustment_factor IS 'Esta tabla contiene los factores que se aplican a diferentes materiales, como el 1.05 para el poliestireno.';
COMMENT ON COLUMN adjustment_factor.name IS 'Nombre del factor de ajuste (por ejemplo, "Factor Poliestireno").';
COMMENT ON COLUMN adjustment_factor.value IS 'El valor del factor de ajuste (Por ejemplo, 1.05).';
-- Insert
